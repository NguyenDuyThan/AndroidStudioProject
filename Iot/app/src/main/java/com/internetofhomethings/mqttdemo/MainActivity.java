...
//                case R.id.navigation:
                    ...
                    clientid = "mqtt" + i1;
                    Log.d(TAG, "onNavigationItemSelected: button connect is pressed");
// This code run ok
...
//                    }
                ...
                case R.id.navigation_subscribe:
                    Log.d(TAG, "onNavigationItemSelected: button sub is pressed");
                    // this code run ok
//                    if(!pahoMqttClient.mqttAndroidClient.isConnected() ) {
...
//                    }
                ...
                case R.id.navigation_publish:
                    Log.d(TAG, "onNavigationItemSelected: button pub is pressed");
                    //this code run ok
...
//        offBtnClick = (Button) findViewById(R.id.offButton);
//        offBtnClick.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//            }
//        });
        onBtnClick = (Button) findViewById(R.id.onButton);
